...
declare module "litegraph.js" {
    ...
    export const LiteGraph: {
        ...
        registered_slot_in_types: Record<string, { nodes: Array<Node> }>;
        // slot types for nodeclass
        registered_slot_out_types: Record<string, { nodes: Array<Node> }>;
        // slot types IN
        slot_types_in: Array<string>;
        // slot types OUT
        slot_types_out: Array<string>;
